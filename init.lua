...
local status_cmds = {
  [1] = "ScrewMachine_State_1",
  [2] = "ScrewMachine_State_2",
  [3] = "ScrewMachine_State_3",
  [4] = "ScrewMachine_State_4",
  [5] = "ScrewMachine_State_5",
  [6] = "ScrewMachine_State_6",
  [7] = "ScrewMachine_State_7",
  [8] = "ScrewMachine_State_8",
  [9] = "ScrewMachine_State_9",
